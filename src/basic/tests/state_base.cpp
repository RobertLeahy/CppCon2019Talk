...
using state_base = basic::state_base<std::experimental::net::io_context::executor_type,
                                     completion_handler>;
...
static_assert(std::is_constructible_v<state_base,
                                      std::experimental::net::io_context::executor_type,
                                      completion_handler>);
...
using throwing_state_base = basic::state_base<std::experimental::net::io_context::executor_type,
...
using custom_executor_state_base = basic::state_base<std::experimental::net::system_executor,
                                                     completion_handler>;
...
public:
  using executor_type = std::experimental::net::io_context::executor_type;
...
using customized_executor_state_base = basic::state_base<std::experimental::net::system_executor,
...
TEST_CASE("Customized executor",
          "[state_base]")
{
  std::experimental::net::io_context a;
  custom_executor_completion_handler handler(a.get_executor());
  std::experimental::net::io_context b;
  basic::state_base<std::experimental::net::io_context::executor_type,
